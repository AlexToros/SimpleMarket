<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Admin/Admin.Master" AutoEventWireup="true" 
    CodeBehind="Orders.aspx.cs" Inherits="GameStore.Pages.Admin.Orders" EnableViewState="false" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="outerContainer">
        <table id="ordersTable">
            ...
            <asp:Repeater ID="Repeater1" runat="server" SelectMethod="GetOrders" ItemType="GameStore.Order">
                <ItemTemplate>
                    <tr>
                        <td><%#: Item.Name %></td>
                        <td><%#: Item.City %></td>
    ...
    <div id ="ordersCheck">
        ...
        Показать отправленные в службу поддержку заказы?
     </div>
</asp:Content>
